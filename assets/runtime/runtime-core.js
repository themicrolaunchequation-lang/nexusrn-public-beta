...
(function(){
  ...
  async function audit(){
    ...
    var heldVisible=typeOptions.some(function(v){return /image-hotspot|audio-hotspot|highlight/.test(v);});
    ...
    var result={
      ...
      heldTypes:['image-hotspot','audio-hotspot','highlight'],
  ...
  function decorate(){
    ...
    var build=$('.ws-build'); if(build) build.textContent='v243I Curated guided sample · Workstation Preview · Asset Rendering Sandbox · native fallback preserved';
    ...
    var nav=$('.ws-nav');
    if(nav && !nav.querySelector('[href*="public-demo"]')){
      var a=document.createElement('a');a.href='../public-demo/index.html';a.textContent='Workstation Preview';nav.appendChild(a);
    }
  }
